...
class LoginController extends Controller
{
    ...
    */
    ...
    public function __construct()
    {
     ...
     $this->middleware('guest')->except('logout');
       ...
       //$this->middleware('guest:membered')->except('logout');
  ...
  public function login(Request $request){
   ...
   if (Auth::guard('admin')->attempt( $user_data ,$request->filled('remember'))) {
     ...
     //if not login
     Session::flash('error','The Credential you enter is not in our record');
     return Redirect::back();
    // return response()->json(['error' => 'Unauthenticated'], 404);
     //or
     //return redirect()->back()->with('error','The Credential you enter is not in our record');
     //or
